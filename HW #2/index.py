...
word_number = BidirectionalDict() # (word: number) is a bijective mapping
vocab_size = 0 # Number of words encountered
		...
		for line in next_doc:
			...
			for word in words:
				...
				if dictionary[reduced_word] == 0: # First occurence of reduced_word
					...
					line_number = word_number[reduced_word] + 1 # Using linecache, lines start at 1 (not at 0)
